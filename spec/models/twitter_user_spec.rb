...
describe TwitterUser do
  ...
  it "should return a list of the users mututal followers" do
    TwitterUser.any_instance.stub(:get_following_ids).with("nemrow").and_return(json_fixture('follower_ids_1.json'))
    TwitterUser.any_instance.stub(:get_following_ids).with("dpolaske").and_return(json_fixture('follower_ids_2.json'))
